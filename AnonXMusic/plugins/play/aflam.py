"""
        ...
        [InlineKeyboardButton("M", callback_data="moslsl " + str(m.from_user.id))],
...
async def aflamAR(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𓏺 ََِ𝗠𝗔𝗗𝗥𝗜𝗗 ↺", url=f"https://t.me/M_C_II")],
...
async def film(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("M", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("𓏺 ََِ𝗠𝗔𝗗𝗥𝗜𝗗 ↺", url=f"https://t.me/M_C_II")],
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("M", callback_data="film " + str(m.from_user.id))],
        [InlineKeyboardButton("𓏺 ََِ𝗠𝗔𝗗𝗥𝗜𝗗 ↺", url=f"https://t.me/M_C_II")],
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("M", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("𓏺 ََِ𝗠𝗔𝗗𝗥𝗜𝗗 ↺", url=f"https://t.me/M_C_II")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("M", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("𓏺 ََِ𝗠𝗔𝗗𝗥𝗜𝗗 ↺", url=f"https://t.me/M_C_II")],
